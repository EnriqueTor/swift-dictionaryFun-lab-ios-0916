...
countForIceCreamFlavor("Peanut Butter and Chocolate")
countForIceCreamFlavor("Pistachio")
/*: directions5
...
func iceCreamForPerson(name: String) -> String? {
    let favoriteIceCream = favoriteFlavorsOfIceCream[name]
...
iceCreamForPerson("Deniz")
iceCreamForPerson("Suzie")
/*: directions7
...
func replaceFlavor(flavor: String, forPerson person: String) -> Bool {
    ...
    if flavor != favoriteFlavorsOfIceCream[person] && favoriteFlavorsOfIceCream[person] != nil {
...
replaceFlavor("Cookies 'N' Cream", forPerson: "Mark")
replaceFlavor("Coffee", forPerson: "Suzie")
/*: directions9
